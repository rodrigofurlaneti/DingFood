...
using NSubstitute;
using DingFood.Application.Features.Orders.MarkReady;
using DingFood.Domain.Constants;
using DingFood.Domain.Entities;
using DingFood.Domain.Repositories;
using Xunit;

namespace DingFood.Tests.Application.Features.Orders.MarkReady;
...
public sealed class MarkOrderReadyCommandHandlerTests
{
    ...
    private Task<DingFood.Domain.Primitives.Result> Run(CustomerOrder? order)
    {
