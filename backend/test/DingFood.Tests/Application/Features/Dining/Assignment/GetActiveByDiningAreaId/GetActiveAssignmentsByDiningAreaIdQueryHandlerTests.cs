...
using Xunit;
using DiningAreaAssignment = DingFood.Domain.Entities.DiningAreaAssignment;

namespace DingFood.Tests.Application.Features.Dining.Assignment.GetActiveByDiningAreaId;
