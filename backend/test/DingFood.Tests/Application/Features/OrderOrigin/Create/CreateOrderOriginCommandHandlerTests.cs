...
using NSubstitute;
using DingFood.Application.Features.OrderOrigin.Create;
using DingFood.Domain.Entities;
using DingFood.Domain.Repositories;
using Xunit;

namespace DingFood.Tests.Application.Features.OrderOrigin.Create;
...
public sealed class CreateOrderOriginCommandHandlerTests
{
    ...
    public async Task Handle_NameAlreadyExists_ShouldReturnFailureWithoutPersisting()
    {
        ...
        await _orderOriginRepository.DidNotReceive().AddAsync(Arg.Any<DingFood.Domain.Entities.OrderOrigin>(), Arg.Any<CancellationToken>());
    }
    ...
    public async Task Handle_ValidCommand_ShouldPersistAndReturnNewId()
    {
        ...
        await _orderOriginRepository.Received(1).AddAsync(
            Arg.Is<DingFood.Domain.Entities.OrderOrigin>(o => o.Name == "MARKETPLACE"), Arg.Any<CancellationToken>());
