...
namespace DingFood.Tests.Application.Features.OrderOrigin.GetByCompanyAndBranch;
...
public sealed class GetOrderOriginsByCompanyAndBranchQueryHandlerTests
{
    ...
    {
        var origin = DingFood.Domain.Entities.OrderOrigin.Create(1, 2, "CUSTOM", DateTime.Now).Value;
