...
namespace DingFood.Tests.Application.Features.OrderOrigin.Update;
...
public sealed class UpdateOrderOriginCommandHandlerTests
{
    ...
    private static DingFood.Domain.Entities.OrderOrigin CreateOrigin(string name = "LOCAL")
        => DingFood.Domain.Entities.OrderOrigin.Create(1, 1, name, DateTime.Now).Value;
