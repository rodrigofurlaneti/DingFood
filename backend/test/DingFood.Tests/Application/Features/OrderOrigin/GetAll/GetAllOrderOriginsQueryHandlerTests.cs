...
namespace DingFood.Tests.Application.Features.OrderOrigin.GetAll;
...
public sealed class GetAllOrderOriginsQueryHandlerTests
{
    ...
    {
        var origin = DingFood.Domain.Entities.OrderOrigin.Create(null, null, "LOCAL", DateTime.Now).Value;
