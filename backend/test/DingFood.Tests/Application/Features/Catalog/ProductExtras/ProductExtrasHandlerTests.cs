...
namespace DingFood.Tests.Application.Features.Catalog.ProductExtras;
...
public sealed class ProductExtrasHandlerTests
{
    ...
    {
        var product = DingFood.Domain.Entities.Product.Create(1, 1, 1, "Drink", null, null, 10, null, false, null).Value;
