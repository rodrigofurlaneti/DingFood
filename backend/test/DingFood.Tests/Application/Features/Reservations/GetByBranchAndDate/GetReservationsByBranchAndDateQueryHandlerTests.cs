...
using NSubstitute;
using DingFood.Application.Features.Reservations.GetByBranchAndDate;
using DingFood.Domain.Entities;
using DingFood.Domain.Repositories;
using Xunit;

namespace DingFood.Tests.Application.Features.Reservations.GetByBranchAndDate;
...
public sealed class GetReservationsByBranchAndDateQueryHandlerTests
{
    ...
    public async Task Handle_MultipleReservations_ShouldMapAllFields()
    {
        ...
        responsePending.ReservationStatusId.Should().Be(DingFood.Domain.Constants.ReservationStatusIds.Pending);
        ...
        responseConfirmed.ReservationStatusId.Should().Be(DingFood.Domain.Constants.ReservationStatusIds.Confirmed);
    }
}
