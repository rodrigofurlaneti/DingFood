...
namespace DingFood.Tests.Application.Features.Checkout.PayOrderWithBoleto;
...
public sealed class PayOrderWithBoletoCommandHandlerTests
{
    ...
    public PayOrderWithBoletoCommandHandlerTests()
    {
        _handler = new PayOrderWithBoletoCommandHandler(
            _checkoutPreparer, _paymentRepository, _asaasService, _mediator, _logRepository, _unitOfWork, DingFood.Tests.PaymentAvailabilityFixture.Allowed());
    }
