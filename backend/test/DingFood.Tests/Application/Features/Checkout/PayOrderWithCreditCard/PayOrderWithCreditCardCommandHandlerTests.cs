...
using DingFood.Application.Abstractions.Integrations.Asaas;
using DingFood.Application.Features.Checkout.PayOrderWithCreditCard;
using DingFood.Application.Features.Checkout.Shared;
using DingFood.Application.Features.Integrations.Asaas.Payment.Create;
using DingFood.Application.Features.Integrations.Asaas.SavedCard.Create;
...
namespace DingFood.Tests.Application.Features.Checkout.PayOrderWithCreditCard;
...
public sealed class PayOrderWithCreditCardCommandHandlerTests
{
    ...
    public PayOrderWithCreditCardCommandHandlerTests()
    {
        _handler = new PayOrderWithCreditCardCommandHandler(
            _checkoutPreparer, _savedCardRepository, _paymentRepository, _asaasService, _mediator, _logRepository, _unitOfWork, DingFood.Tests.PaymentAvailabilityFixture.Allowed());
    }
