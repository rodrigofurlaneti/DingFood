...
using DingFood.Application.Features.Integrations.Keeta.Setting.GetByCompanyIdForUpdate;
using Xunit;

namespace DingFood.Tests.Application.Features.Integrations.Keeta.Setting.GetByCompanyIdForUpdate;
