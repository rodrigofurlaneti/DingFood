...
using DingFood.Application.Features.Integrations.Keeta.Setting.GetByIdForUpdate;
using Xunit;

namespace DingFood.Tests.Application.Features.Integrations.Keeta.Setting.GetByIdForUpdate;
