...
namespace DingFood.Tests.Application.Features.Integrations.IFood.Shipping;
...
public sealed class IFoodShippingTokenResolutionTests
{
    ...
    private Task<DingFood.Domain.Primitives.Result<(IfoodShippingDelivery Delivery, string Token)>> Resolve()
