...
namespace DingFood.Tests.Application.Features.Integrations.IFood.Merchant;
...
public sealed class IFoodMerchantResolutionTests
{
    ...
    private Task<DingFood.Domain.Primitives.Result<(long CompanyId, string MerchantId, string Token, string? IfoodCustomerId)>> Resolve()
