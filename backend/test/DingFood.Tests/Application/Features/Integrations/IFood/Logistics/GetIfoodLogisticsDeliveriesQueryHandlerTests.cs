...
namespace DingFood.Tests.Application.Features.Integrations.IFood.Logistics;
...
public sealed class GetIfoodLogisticsDeliveriesQueryHandlerTests
{
    ...
    private static CustomerOrder CreateCustomerOrder()
        => CustomerOrder.Create(
            ...
            Now: DateTime.Now, orderTypeId: DingFood.Domain.Constants.OrderTypeIds.Delivery,
