...
using DingFood.Application.Features.Integrations.Asaas.Setting.GetByBranchIdForUpdate;
using Xunit;

namespace DingFood.Tests.Application.Features.Integrations.Asaas.Setting.GetByBranchIdForUpdate;
