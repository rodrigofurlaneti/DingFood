...
using NSubstitute;
using DingFood.Application.Features.Integrations.Asaas.Setting.GetByCompanyIdForUpdate;
using DingFood.Domain.Entities;
using DingFood.Domain.Repositories;
using Xunit;

namespace DingFood.Tests.Application.Features.Integrations.Asaas.Setting.GetByCompanyIdForUpdate;
