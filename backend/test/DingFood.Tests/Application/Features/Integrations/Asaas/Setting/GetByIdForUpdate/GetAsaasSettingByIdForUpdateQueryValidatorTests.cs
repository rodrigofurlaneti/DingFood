...
using DingFood.Application.Features.Integrations.Asaas.Setting.GetByIdForUpdate;
using Xunit;

namespace DingFood.Tests.Application.Features.Integrations.Asaas.Setting.GetByIdForUpdate;
