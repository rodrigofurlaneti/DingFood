...
using DingFood.Application.Features.CustomerAppUser.GetByBranchId;
using DingFood.Application.Features.CustomerAppUser.GetByCompanyId;
using DingFood.Application.Features.CustomerAppUser.GetByCustomerId;
using DingFood.Application.Features.CustomerAppUser.GetById;
using DingFood.Application.Features.CustomerAppUser.Remove;
using DingFood.Application.Features.CustomerAppUser.Update;
...
public sealed class CustomerAppUsersControllerTests
{
    ...
    public async Task GetById_Success_ShouldSendQueryAndReturnOk()
    {
        _mediator.Send(Arg.Is<GetCustomerAppUserByIdQuery>(q => q.Id == 1), Arg.Any<CancellationToken>())
            .Returns(Result.Success((DingFood.Application.Features.CustomerAppUser.GetById.CustomerAppUserResponse)null!));
    ...
    public async Task GetById_Failure_ShouldReturnMappedErrorResult()
    {
        _mediator.Send(Arg.Any<GetCustomerAppUserByIdQuery>(), Arg.Any<CancellationToken>())
            .Returns(Result.Failure<DingFood.Application.Features.CustomerAppUser.GetById.CustomerAppUserResponse>(new Error("CustomerAppUser.NotFound", "usuario nao encontrado")));
    ...
    public async Task GetByCustomerId_Success_ShouldSendQueryAndReturnOk()
    {
        _mediator.Send(Arg.Is<GetCustomerAppUsersByCustomerIdQuery>(q => q.CustomerId == 1), Arg.Any<CancellationToken>())
            .Returns(Result.Success<IEnumerable<DingFood.Application.Features.CustomerAppUser.GetByCustomerId.CustomerAppUserResponse>>([]));
    ...
    public async Task GetByCustomerId_Failure_ShouldReturnMappedErrorResult()
    {
        _mediator.Send(Arg.Any<GetCustomerAppUsersByCustomerIdQuery>(), Arg.Any<CancellationToken>())
            .Returns(Result.Failure<IEnumerable<DingFood.Application.Features.CustomerAppUser.GetByCustomerId.CustomerAppUserResponse>>(new Error("Customer.NotFound", "cliente nao encontrado")));
    ...
    public async Task GetByCompanyId_Success_ShouldSendQueryAndReturnOk()
    {
        _mediator.Send(Arg.Is<GetCustomerAppUsersByCompanyIdQuery>(q => q.CompanyId == 1), Arg.Any<CancellationToken>())
            .Returns(Result.Success<IEnumerable<DingFood.Application.Features.CustomerAppUser.GetByCompanyId.CustomerAppUserResponse>>([]));
    ...
    public async Task GetByCompanyId_Failure_ShouldReturnMappedErrorResult()
    {
        _mediator.Send(Arg.Any<GetCustomerAppUsersByCompanyIdQuery>(), Arg.Any<CancellationToken>())
            .Returns(Result.Failure<IEnumerable<DingFood.Application.Features.CustomerAppUser.GetByCompanyId.CustomerAppUserResponse>>(new Error("Company.NotFound", "empresa nao encontrada")));
    ...
    public async Task GetByBranchId_Success_ShouldSendQueryAndReturnOk()
    {
        _mediator.Send(Arg.Is<GetCustomerAppUsersByBranchIdQuery>(q => q.BranchId == 1), Arg.Any<CancellationToken>())
            .Returns(Result.Success<IEnumerable<DingFood.Application.Features.CustomerAppUser.GetByBranchId.CustomerAppUserResponse>>([]));
    ...
    public async Task GetByBranchId_Failure_ShouldReturnMappedErrorResult()
    {
        _mediator.Send(Arg.Any<GetCustomerAppUsersByBranchIdQuery>(), Arg.Any<CancellationToken>())
            .Returns(Result.Failure<IEnumerable<DingFood.Application.Features.CustomerAppUser.GetByBranchId.CustomerAppUserResponse>>(new Error("Branch.NotFound", "filial nao encontrada")));
