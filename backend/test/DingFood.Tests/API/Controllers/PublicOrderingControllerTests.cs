...
using DingFood.Application.Features.PublicOrdering.GetPublicComandaBill;
...
public sealed class PublicOrderingControllerTests
{
    ...
    {
        _controller = new PublicOrderingController(_mediator, _logRepository, _unitOfWork, Substitute.For<DingFood.Application.Abstractions.Security.IReadingProofService>());
