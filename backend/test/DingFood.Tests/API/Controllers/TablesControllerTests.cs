...
using DingFood.Application.Features.Tables;
using DingFood.Application.Features.Tables.GenerateQrToken;
using DingFood.Application.Features.Tables.GetByBranch;
using DingFood.Application.Features.Tables.SetReadingValidation;
