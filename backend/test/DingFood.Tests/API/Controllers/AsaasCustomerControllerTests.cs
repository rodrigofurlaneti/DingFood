...
using DingFood.Application.Features.Integrations.Asaas.Customer.Create;
using DingFood.Application.Features.Integrations.Asaas.Customer.Delete;
using DingFood.Application.Features.Integrations.Asaas.Customer.Exists;
using DingFood.Application.Features.Integrations.Asaas.Customer.GetAllByCompanyId;
using DingFood.Application.Features.Integrations.Asaas.Customer.GetByAsaasCustomerId;
using DingFood.Application.Features.Integrations.Asaas.Customer.GetByCustomerIdAndCompanyId;
using DingFood.Application.Features.Integrations.Asaas.Customer.GetById;
using DingFood.Application.Features.Integrations.Asaas.Customer.Update;
...
public sealed class AsaasCustomerControllerTests
{
    ...
    public async Task GetById_Success_ShouldSendQueryAndReturnOk()
    {
        _mediator.Send(Arg.Is<GetAsaasCustomerByIdQuery>(q => q.Id == 1), Arg.Any<CancellationToken>())
            .Returns(Result.Success((DingFood.Application.Features.Integrations.Asaas.Customer.GetAllByCompanyId.AsaasIntegrationCustomerResponse)null!));
    ...
    public async Task GetById_Failure_ShouldReturnMappedErrorResult()
    {
        _mediator.Send(Arg.Any<GetAsaasCustomerByIdQuery>(), Arg.Any<CancellationToken>())
            .Returns(Result.Failure<DingFood.Application.Features.Integrations.Asaas.Customer.GetAllByCompanyId.AsaasIntegrationCustomerResponse>(new Error("AsaasIntegrationCustomer.NotFound", "vinculo nao encontrado")));
    ...
    public async Task GetAllByCompany_Success_ShouldSendQueryAndReturnOk()
    {
        _mediator.Send(Arg.Is<GetAllAsaasCustomersByCompanyIdQuery>(q => q.CompanyId == 1), Arg.Any<CancellationToken>())
            .Returns(Result.Success<IReadOnlyList<DingFood.Application.Features.Integrations.Asaas.Customer.GetAllByCompanyId.AsaasIntegrationCustomerResponse>>([]));
    ...
    public async Task GetAllByCompany_Failure_ShouldReturnMappedErrorResult()
    {
        _mediator.Send(Arg.Any<GetAllAsaasCustomersByCompanyIdQuery>(), Arg.Any<CancellationToken>())
            .Returns(Result.Failure<IReadOnlyList<DingFood.Application.Features.Integrations.Asaas.Customer.GetAllByCompanyId.AsaasIntegrationCustomerResponse>>(new Error("Company.NotFound", "empresa nao encontrada")));
    ...
    public async Task GetByCustomerAndCompany_Success_ShouldSendQueryAndReturnOk()
    {
        _mediator.Send(Arg.Is<GetByCustomerIdAndCompanyIdQuery>(q => q.CustomerId == 2 && q.CompanyId == 1), Arg.Any<CancellationToken>())
            .Returns(Result.Success((DingFood.Application.Features.Integrations.Asaas.Customer.GetByCustomerIdAndCompanyId.AsaasIntegrationCustomerResponse)null!));
    ...
    public async Task GetByCustomerAndCompany_Failure_ShouldReturnMappedErrorResult()
    {
        _mediator.Send(Arg.Any<GetByCustomerIdAndCompanyIdQuery>(), Arg.Any<CancellationToken>())
            .Returns(Result.Failure<DingFood.Application.Features.Integrations.Asaas.Customer.GetByCustomerIdAndCompanyId.AsaasIntegrationCustomerResponse>(
