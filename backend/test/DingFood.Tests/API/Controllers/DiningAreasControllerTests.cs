...
using DingFood.Application.Features.Dining.Area;
using DingFood.Application.Features.Dining.Area.Create;
using DingFood.Application.Features.Dining.Area.GetByBranchId;
using DingFood.Application.Features.Dining.Area.GetById;
using DingFood.Application.Features.Dining.Area.Update;
using DingFood.Application.Features.Dining.Assignment;
using DingFood.Application.Features.Dining.Assignment.Create;
using DingFood.Application.Features.Dining.Assignment.End;
using DingFood.Application.Features.Dining.Assignment.GetActiveByDiningAreaId;
using DingFood.Application.Features.Dining.Assignment.GetActiveByEmployeeId;
using DingFood.Application.Features.Dining.Messages;
using DingFood.Application.Features.Dining.Messages.Create;
using DingFood.Application.Features.Dining.Messages.GetWaiterMessagesByBranch;
using DingFood.Application.Features.Dining.Table;
using DingFood.Application.Features.Dining.Table.Create;
using DingFood.Application.Features.Dining.Table.Deactivate;
using DingFood.Application.Features.Dining.Table.GetByDiningAreaId;
using DingFood.Application.Features.Dining.Table.Update;
