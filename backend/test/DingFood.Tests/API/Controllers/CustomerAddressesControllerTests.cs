...
using DingFood.Application.Features.CustomerAddresses.Create;
using DingFood.Application.Features.CustomerAddresses.GetByBranchId;
using DingFood.Application.Features.CustomerAddresses.GetByCompanyId;
using DingFood.Application.Features.CustomerAddresses.GetByCustomerId;
using DingFood.Application.Features.CustomerAddresses.GetById;
using DingFood.Application.Features.CustomerAddresses.RegisterOrder;
using DingFood.Application.Features.CustomerAddresses.Remove;
using DingFood.Application.Features.CustomerAddresses.Update;
...
public sealed class CustomerAddressesControllerTests
{
    ...
    public async Task GetById_Success_ShouldSendQueryAndReturnOk()
    {
        _mediator.Send(Arg.Is<GetCustomerAddressByIdQuery>(q => q.Id == 1), Arg.Any<CancellationToken>())
            .Returns(Result.Success((DingFood.Application.Features.CustomerAddresses.GetById.CustomerAddressResponse)null!));
    ...
    public async Task GetById_Failure_ShouldReturnMappedErrorResult()
    {
        _mediator.Send(Arg.Any<GetCustomerAddressByIdQuery>(), Arg.Any<CancellationToken>())
            .Returns(Result.Failure<DingFood.Application.Features.CustomerAddresses.GetById.CustomerAddressResponse>(new Error("CustomerAddress.NotFound", "endereco nao encontrado")));
    ...
    public async Task GetByCustomerId_Success_ShouldSendQueryAndReturnOk()
    {
        _mediator.Send(Arg.Is<GetCustomerAddressesByCustomerIdQuery>(q => q.CustomerId == 1), Arg.Any<CancellationToken>())
            .Returns(Result.Success<IEnumerable<DingFood.Application.Features.CustomerAddresses.GetByCustomerId.CustomerAddressResponse>>([]));
    ...
    public async Task GetByCustomerId_Failure_ShouldReturnMappedErrorResult()
    {
        _mediator.Send(Arg.Any<GetCustomerAddressesByCustomerIdQuery>(), Arg.Any<CancellationToken>())
            .Returns(Result.Failure<IEnumerable<DingFood.Application.Features.CustomerAddresses.GetByCustomerId.CustomerAddressResponse>>(new Error("Customer.NotFound", "cliente nao encontrado")));
    ...
    public async Task GetByCompanyId_Success_ShouldSendQueryAndReturnOk()
    {
        _mediator.Send(Arg.Is<GetCustomerAddressesByCompanyIdQuery>(q => q.CompanyId == 1), Arg.Any<CancellationToken>())
            .Returns(Result.Success<IEnumerable<DingFood.Application.Features.CustomerAddresses.GetByCompanyId.CustomerAddressResponse>>([]));
    ...
    public async Task GetByCompanyId_Failure_ShouldReturnMappedErrorResult()
    {
        _mediator.Send(Arg.Any<GetCustomerAddressesByCompanyIdQuery>(), Arg.Any<CancellationToken>())
            .Returns(Result.Failure<IEnumerable<DingFood.Application.Features.CustomerAddresses.GetByCompanyId.CustomerAddressResponse>>(new Error("Company.NotFound", "empresa nao encontrada")));
    ...
    public async Task GetByBranchId_Success_ShouldSendQueryAndReturnOk()
    {
        _mediator.Send(Arg.Is<GetCustomerAddressesByBranchIdQuery>(q => q.BranchId == 1), Arg.Any<CancellationToken>())
            .Returns(Result.Success<IEnumerable<DingFood.Application.Features.CustomerAddresses.GetByBranchId.CustomerAddressResponse>>([]));
    ...
    public async Task GetByBranchId_Failure_ShouldReturnMappedErrorResult()
    {
        _mediator.Send(Arg.Any<GetCustomerAddressesByBranchIdQuery>(), Arg.Any<CancellationToken>())
            .Returns(Result.Failure<IEnumerable<DingFood.Application.Features.CustomerAddresses.GetByBranchId.CustomerAddressResponse>>(new Error("Branch.NotFound", "filial nao encontrada")));
