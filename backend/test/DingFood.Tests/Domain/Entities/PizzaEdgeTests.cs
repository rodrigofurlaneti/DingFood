...
namespace DingFood.Tests.Domain.Entities
{
    ...
    // aggregate PizzaConfiguration) — acessíveis aqui via InternalsVisibleTo de DingFood.Domain
    // para DingFood.Tests, mesmo padrão já usado para handlers 'internal sealed' da Application.
