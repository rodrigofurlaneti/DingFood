...
// endpoints sem duplicar um sistema de tipos inteiro para uma API que nenhum merchant do DingFood
...
// resto do módulo Catalog, aqui não há nada pra confirmar campo-a-campo. O DingFood aceita o JSON
