...
/// identificador string usado no módulo Order — não confundir com o Id local do DingFood).
...
/// na DTO acima. Não há necessidade de mais que isso no fluxo essencial porque o DingFood já guarda
