...
/// concreta na Infrastructure, registrada em DingFood.Infrastructure.DependencyInjection.
///
/// <paramref name="purpose"/> isola criptograficamente segredos de features diferentes (ex.:
/// "DingFood.Integrations.Ifood.ClientSecret.v1") — use uma string fixa e nunca a troque depois
