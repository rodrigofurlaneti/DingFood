...
using DingFood.Application.Abstractions.Security; // ajuste o namespace conforme onde ICurrentUserService estiver
using DingFood.Domain.Constants;
using DingFood.Domain.Entities;
using DingFood.Domain.Primitives;
using DingFood.Domain.Repositories;

namespace DingFood.Application.Features.Stock.RegisterMovement;
