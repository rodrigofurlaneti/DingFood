...
namespace DingFood.Application.Features.Integrations.Ifood.Catalog.Pizza;

// Fase 17 — cria/atualiza uma pizza no catálogo v1 (legado) do Ifood a partir de uma
// PizzaConfiguration do DingFood. Diferente de produto/complemento/categoria (idempotentes por id
// local gerado pelo DingFood e enviado no create), a API de pizza do v1 NÃO aceita um id proposto —
