...
namespace DingFood.Application.Features.Integrations.Ifood.Catalog.V1Legacy;
...
// um sistema de tipos inteiro pra uma API que nenhum merchant do DingFood usa hoje.
