...
{
    [HttpGet("{id:long}")]
    [ProducesResponseType(typeof(DingFood.Application.Features.Integrations.Asaas.Customer.GetAllByCompanyId.AsaasIntegrationCustomerResponse), StatusCodes.Status200OK)]
    ...
    [ProducesResponseType(typeof(IReadOnlyList<DingFood.Application.Features.Integrations.Asaas.Customer.GetAllByCompanyId.AsaasIntegrationCustomerResponse>), StatusCodes.Status200OK)]
    ...
    [ProducesResponseType(typeof(DingFood.Application.Features.Integrations.Asaas.Customer.GetByCustomerIdAndCompanyId.AsaasIntegrationCustomerResponse), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
