...
using DingFood.Application.Features.Checkout.PayOrderWithBoleto;
using DingFood.Application.Features.Checkout.PayOrderWithCreditCard;
using DingFood.Application.Features.Checkout.PayOrderWithPix;
...
namespace DingFood.API.Controllers
{
        ...
        IUnitOfWork unitOfWork) : ApiController(mediator)
    {
        ...
        public async Task<IActionResult> PayWithDebit([FromBody] CheckoutPixRequest request, CancellationToken ct)
        {
            ...
            var result = await Mediator.Send(new DingFood.Application.Features.Checkout.PayOrderWithDebitCard.PayOrderWithDebitCardCommand(request.CustomerOrderId.Value), ct);
