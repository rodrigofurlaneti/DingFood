...
using DingFood.Application.Features.Integrations.Ifood;
using DingFood.Application.Features.Integrations.Ifood.Analytics;
using DingFood.Application.Features.Integrations.Ifood.Catalog;
using DingFood.Application.Features.Integrations.Ifood.Catalog.Admin;
using DingFood.Application.Features.Integrations.Ifood.Catalog.Categories;
using DingFood.Application.Features.Integrations.Ifood.Catalog.Items;
using DingFood.Application.Features.Integrations.Ifood.Catalog.OptionGroups;
using DingFood.Application.Features.Integrations.Ifood.Catalog.Products;
using DingFood.Application.Features.Integrations.Ifood.Catalog.V1Legacy;
using DingFood.Application.Features.Integrations.Ifood.Financial;
using DingFood.Application.Features.Integrations.Ifood.Logistics;
...
using DingFood.Application.Features.Integrations.Ifood.Review;
using DingFood.Application.Features.Integrations.Ifood.Shipping;
