...
using DingFood.Application.Features.Orders.AddItemComplement;
using DingFood.Application.Features.Orders.AddPizzaItem;
using DingFood.Application.Features.Orders.ApplyDiscount;
using DingFood.Application.Features.Orders.Cancel;
using DingFood.Application.Features.Orders.Close;
using DingFood.Application.Features.Orders.GetById;
using DingFood.Application.Features.Orders.GetOpenByBranch;
using DingFood.Application.Features.Orders.GetQrViewSetting;
using DingFood.Application.Features.Orders.GetTableReadingValidationSetting;
using DingFood.Application.Features.Orders.Open;
using DingFood.Application.Features.Orders.RaiseComandaLimit;
using DingFood.Application.Features.Orders.RemoveItemComplement;
using DingFood.Application.Features.Orders.RemoveServiceFee;
using DingFood.Application.Features.Orders.Reopen;
using DingFood.Application.Features.Orders.ServiceFeeSetting;
using DingFood.Application.Features.Orders.SetQrViewEnabled;
using DingFood.Application.Features.Orders.SetTableReadingValidation;
using DingFood.Application.Features.Orders.SplitBill;
using DingFood.Application.Features.Orders.StartPreparation;
using DingFood.Application.Features.Orders.TransferComandaAllItem;
using DingFood.Application.Features.Orders.TransferComandaItem;
using DingFood.Application.Features.Orders.TransferItem;
using DingFood.Application.Features.Orders.TransferTableItems;
using DingFood.Application.Features.Orders.UpdateItemStatus;
    ...
    IUnitOfWork unitOfWork) : ApiController(mediator)
{
    ...
    public Task<IActionResult> MarkReadyForDispatch(long id, CancellationToken ct) =>
        ...
        {
            var result = await Mediator.Send(new DingFood.Application.Features.Orders.MarkReady.MarkOrderReadyCommand(id), ct);
            return result.IsFailure ? HandleFailure(result) : NoContent();
        });
