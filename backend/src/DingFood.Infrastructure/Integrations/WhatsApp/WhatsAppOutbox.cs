...
namespace DingFood.Infrastructure.Integrations.WhatsApp;
...
{
    private readonly IDataProtector _protector = protection.CreateProtector("DingFood.WhatsApp.Outbox.v1");
