...
/// DingFood comandar nesse caso). 1:1 com <see cref="IfoodOrder"/>, referenciado pelo Id LOCAL
/// (long) do DingFood — não pelo IfoodOrderId string do Ifood, mesma convenção de FK usada em
